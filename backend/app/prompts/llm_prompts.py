...
- НЕ завышай оценку за длину текста: короткий точный ответ может получить 5 за ПОЛНОТУ; длинный ответ без новой информации — 2
...
3. ПОЛНОТА — насколько ответ содержателен и даёт клиенту НУЖНУЮ информацию (1=пустой, 5=исчерпывающий). Помни: ПОЛНОТА — это полезная информация, а не длина. Короткий, но точный ответ = 5.
